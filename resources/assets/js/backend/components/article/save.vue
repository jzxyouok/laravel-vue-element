    ...
    export default {
        ...
        methods: {
            getOriginalData() {
                let _this = this;
                if(_this.form.id) {
                    get('/backend/articles/' + _this.form.id).then(data => {
                    ...
                    get('/backend/article/options').then(data => {
                        _this.options.statusOptions = data.data.statusOptions;
                        _this.options.categoryOptions = data.data.categoryOptions;
                    });
                }
            ...
            submit(formName) {
                ...
                _this.$refs[formName].validate((valid) => {
                    if (valid) {
                        if (!_this.form.id) {
                            var method = 'post', url = '/backend/articles', params = {'data': _this.form};
                        } else {
                            var method = 'put', url = '/backend/articles/' + _this.form.id, params = {'data': _this.form};
                        }
